...
<!--          </li>-->
  ...
  <main id="main" data-aos="fade-in">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h2>Trainers</h2>
        <p>Our trainers have an in-depth knowledge of computers and are reknown for their competency in corporate sectors. </p>
      </div>
    </div><!-- End Breadcrumbs -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="Tutors/john.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Walter Mukanzi</h4>
                <span>Web Development</span>
                <p>
                  Licenced developer with a Masters in Computer Science.
                </p>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="Tutors/Sara.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Sarah Kilwa</h4>
                <span>Marketing</span>
                <p>
                  Incharge of marketing and expert in SEO
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="Tutors/jack.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>William Anderson</h4>
                <span>Content</span>
                <p>
                  Expert in data architecture oon a website to give fluency and uniformity of web contents
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              3rd Floor Vision Plaza along Moi Avenue <br>
              Nairobi City<br>
              Kenya <br><br>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          Copyright &copy; 2022 <strong><span>DotCom Institute of Technology</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
